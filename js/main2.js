...
// const segmentPath2 = pathArray[1];
// console.log(pathArray,segmentPath2)

// handle onload function
const divLoad = document.querySelector(".loead") ;
const seletCode2 = document.querySelector(".input-contry-2") ;
...
window.onload = () => {
    // if(pathArray[1] == "land-page"){
    //     getCountryLandPageForm()
...
// handle onload function
// get country inside landing page
function getCountryLandPageForm(){
...
var swiper = new Swiper(".mySwiperseLandPage", {
...
if(serviceTwoPlay != null) {
    serviceTwoPlay.addEventListener("click" , () => {
        ...
        ifrem.src = e.parentElement.parentElement.parentElement.getAttribute("src").replace("watch?v=" , "embed/")+"?autoplay=1";
...
//
// })
// handle videos youtube iframe for landing pages

function youtubeIframeLandingPage(event){
    event.preventDefault()
    // const playVedios = document.querySelector(".play-youtuobe") ;
    // playVedios.addEventListener("click" , function(tr) {
        let src = "https://www.youtube.com/embed/0FOtRnqG1kU"+"?autoplay=1";
        let iframe = document.createElement("iframe") ;
        let parintElement = document.querySelector(".cover .content .left .imges") ;
        let overlay = document.querySelector(".cover .content .left .imges .overlay")
        let img = document.querySelector(".cover .content .left .imges img ")
